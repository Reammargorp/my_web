       ...
       open("404.html" ,"")
           ...
           open("404.html" ,"")
            ...
            resultSearchSub.onclick = function (e) {
                  if (resultSearchText.value == "website" || resultSearchText.value == "WEBSITE" || resultSearchText.value == "انشاء" || resultSearchText.value == "مواقع"|| resultSearchText.value == "انشاء المواقع" ||  resultSearchText.value == "انشاء مواقع" ||  resultSearchText.value == "انشاء موقع" || resultSearchText.value == "موقع") {
                      resultSearchText.value = ""
                     open("web.html" ,"")
                  }
                  if (resultSearchText.value == "اسئله" || resultSearchText.value == "الاسئله" || resultSearchText.value == "الاسئله الشائعه" || resultSearchText.value == "مواقع" ||  resultSearchText.value == "ask" ||  resultSearchText.value == "اFAQS" || resultSearchText.value == "faqs") {
                      resultSearchText.value = ""
                      open("ask.html" ,"")
                  }
                  if (resultSearchText.value == "الرئيسيه" || resultSearchText.value == "main" ) {
                      resultSearchText.value = ""
                     open("index.html" ,"")
                  }
                if (resultSearchText.value == "services" || resultSearchText.value == "Services" || resultSearchText.value == "خدمات" ||   resultSearchText.value == "خدمه") {
                    resultSearchText.value = ""
                    open("services.html" ,"")
