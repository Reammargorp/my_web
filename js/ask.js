    ...
    search.onclick = function() {
      ...
      let mainBtnUp = document.querySelector(".btn-up")
        ...
        window.onscroll = function(){
          ...
          //
          //
          let closeBoxOne = document.querySelectorAll(".result-box .boxOne .close")
          let askBoxOne = document.querySelectorAll(".result-box .boxOne .box")
          let askBoxOne2 = document.querySelector(".result-box .boxOne")
          let askBoxTwo2 = document.querySelector(".result-box .boxTwo")
          let askCloseBtn = document.querySelectorAll(".result-box .boxOne .box .close")
          let askOpenBtn = document.querySelectorAll(".result-box .boxOne .box .open")

      for(let i = 0; i < askBoxOne.length; i++) {
        askBoxOne[i].onclick = function() {
          askBoxOne[i].classList.add("active");
          askBoxOne.forEach((li) => {
      ...
      //
      for(let i = 0; i < closeBoxOne.length;i++){
        closeBoxOne[i].onclick = () => {
          askBoxOne.forEach((li) => {
            li.addEventListener("click", (e) => {
      ...
      //
      //
      let closeBoxTwo = document.querySelectorAll(".result-box .boxTwo .close")
      let askBoxTwo = document.querySelectorAll(".result-box .boxTwo .box")

      for(let i = 0; i < askBoxTwo.length; i++) {
        askBoxTwo[i].onclick = function() {
            askBoxTwo[i].classList.toggle("active");
            askBoxTwo.forEach((li) => {
            li.addEventListener("click", (e) => {
                askBoxTwo.forEach((li) => {
                    li.classList.remove("active");
                });
      ...
      //
  for(let i = 0; i < closeBoxTwo.length;i++){

    closeBoxTwo[i].onclick = () => {
        askBoxTwo.forEach((li) => {
            li.addEventListener("click", (e) => {
